...
public class Calculadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        casilla.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 51, 204)));
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        ...
        switch (this.operador){
            case "+": this.casilla.setText(sincero(this.primerN+this.segundoN));
            break;
            case "-": this.casilla.setText(sincero(this.primerN+this.segundoN));
            break;
            case "*": this.casilla.setText(sincero(this.primerN+this.segundoN));
            break;
            case "/": if (this.segundoN == 0) {
                    this.casilla.setText("Syntax Error");
                }else{
                this.casilla.setText(sincero(this.primerN+this.segundoN));
            }
            break;
